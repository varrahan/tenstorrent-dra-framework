...
const (
	...
	DeviceAttributeFabricID               = DeviceAttributeDomain + "/fabricID"
	DeviceAttributeRingID                 = DeviceAttributeDomain + "/ringID"
	DeviceAttributeEndpointID             = DeviceAttributeDomain + "/endpointID"
	DeviceAttributeNUMANode               = DeviceAttributeDomain + "/numaNode"
	DeviceAttributePCIBDF                 = DeviceAttributeDomain + "/pciBDF"
	DeviceAttributeLinkClass              = DeviceAttributeDomain + "/linkClass"
